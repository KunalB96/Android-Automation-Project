...
public class LongPress {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
      ...
      //Jio customer care no: 1800-88-99999
		...
		//long press on backspace/delete buttton
		WebElement backspaceBtn= driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc=\"Delete\"]"));
		backspaceBtn.click();  //remove one digit
		
		Thread.sleep(2000);
		
		longPress(backspaceBtn);   //remove all digits
	...
	{
		//find the location of web element
